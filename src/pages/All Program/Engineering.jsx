          ...
          <a href="./contact_us">
            ...
            <div className="programme-cards">
              ...
              <div className="programme-card">
                ...
                <ul>
                  <li>Computer Science & Technology
                     <ul>
                      <li>AI & ML</li>
                      <li>Data Science</li>
                      <li>AI & Robotics</li>
              ...
              <div className="programme-card">
                ...
                <ul>
                  ...
                  <li>B.Tech Marine Engineering(MRE)</li>
                  <li>B.Tech Marine Engineering(MRE) - Lateral</li>
                  <li>B.Sc. Nautical Science(BNS)
                    (Leads to be the Captain of a ship)
                  </li>
              ...
              <div className="programme-card">
                ...
                <div className="card-header">
                  <FaCogs className="card-icon" />
                  <h4>P.G Diploma in Marine Engineering(PGDME)</h4>
                </div>
                <ul>
                ...
                <div className="card-header">
                  <FaCogs className="card-icon" />
                  <h4>Diploma in Nautical  Science(DNS)</h4>
                </div>
                <ul>
