      ...
      <div className="eng-container">
        ...
        <header className="eng-hero">
          <div className="hero-text">
            <h1 className="hero-title">Computational & Applied Science</h1>
          ...
          <div className="hero-image-container">
            <img
              ...
              src="Image/computational1.jpg"
              alt="computational Concepts"
            />
          </div>
        </header>
        ...
        <section className="feature-section">
          ...
          <div className="feature-image-wrapper">
            ...
            <img src="Image/computational2.jpg" alt="Team collaborating" />
          </div>
        </section>
        ...
        <section className="feature-section layout-reversed">
          ...
          <div className="feature-image-wrapper">
            {/* Replace this with your own image */}
            <img src="Image/computational3.jpg" alt="Vision and planning" />
          </div>
        </section>
          ...
          <div className="programme-cards">
            ...
            <div className="programme-card">
              ...
              <ul>
                ...
                <li>Mathematics</li>
                {/* <li>Computer Science & computational</li>
                <li>Data Science & AI</li>
                <li>Electrical computational</li>
                <li>Mechanical computational</li>
                <li>Civil computational</li>
            ...
            <div className="programme-card">
              ...
              <ul>
                ...
                {/* <li>Mechanical computational (Thermal)</li>
                <li>Structural computational</li> */}
              </ul>
            </div>
