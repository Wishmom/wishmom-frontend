      ...
      <div className="eng-container">
        ...
        <header className="eng-hero">
          <div className="hero-text">
            <h1 className="hero-title">Agriculture </h1>
          ...
          <div className="hero-image-container">
            <img
              ...
              src="Image/agriculture1.jpg"
              alt="agriculture Concepts"
            />
          </div>
        </header>
        ...
        <section className="feature-section">
          ...
          <div className="feature-image-wrapper">
            ...
            <img src="Image/agriculture2.jpg" alt="Team collaborating" />
          </div>
        </section>
        ...
        <section className="feature-section layout-reversed">
          ...
          <div className="feature-image-wrapper">
            {/* Replace this with your own image */}
            <img src="Image/agriculture3.jpg" alt="Vision and planning" />
          </div>
        </section>
          ...
          <div className="programme-cards">
            ...
            <div className="programme-card">
              <div className="card-header">
                ...
                <h4>Bachelar Degree</h4>
              </div>
              <ul>
                <li>BSC(HONS) Agriculture</li>
                <li>BSC (HONS) in AGRI Business Management</li>
                <li>Bachelor in Vocational in Agriculture</li>
                {/* <li>LLM</li>
                <li>PHD</li> */}
              </ul>
            </div>
             <div className="programme-card">
              ...
              <ul>
                <li>Agriculture in Agronomy</li>
                <li>Agriculture in Soil Science</li>
                <li>Agriculture in Horticulture</li>
                <li>Agriculture in Genetic and Plant Breeding</li>
                {/* <li>PHD</li> */}
              </ul>
            </div>
            <div className="programme-card">
              ...
              <ul>
                ...
                <li>Advance Diploma in Agriculture</li>
                {/* <li>LLB</li>
                <li>LLM</li>
                <li>PHD</li> */}
              </ul>
