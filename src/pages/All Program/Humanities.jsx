      ...
      <div className="eng-container">
        ...
        <header className="eng-hero">
          <div className="hero-text">
            <h1 className="hero-title">Humanities & Social Science</h1>
          ...
          <div className="hero-image-container">
            <img
              ...
              src="Image/humanities1.jpg"
              alt="humanities Concepts"
            />
          </div>
        </header>
        ...
        <section className="feature-section">
          ...
          <div className="feature-image-wrapper">
            ...
            <img src="Image/humanities1.webp" alt="Team collaborating" />
          </div>
        </section>
        ...
        <section className="feature-section layout-reversed">
          ...
          <div className="feature-image-wrapper">
            {/* Replace this with your own image */}
            <img src="Image/humanities3.jpg" alt="Vision and planning" />
          </div>
        </section>
...
<a href="/contact_us">          <h2>Explore Our Offers</h2>
          <div className="programme-cards">
            ...
            <div className="programme-card">
              ...
              <ul>
                <li>Psychology</li>
                {/* <li>Mechanical humanities</li>
                <li>Electrical humanities</li>
